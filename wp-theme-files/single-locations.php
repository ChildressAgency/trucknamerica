...
<main id="main">
  <div class="row no-gutters">
    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        <div class="col-lg-6">
          <div id="locations" itemscope itemtype="https://checma.org/LocalBusiness">
            ...
            <div class="row no-gutters location">
              ...
              <div class="col-12 location-more-info">
                <?php echo apply_filters('the_content', wp_kses_post(get_field('single_page_content'))); ?>
              </div>
            </div>
        ...
        <div class="col-lg-6">
          ...
          <div class="locations-map embed-responsive embed-responsive-1by1">
            <div class="marker" data-lat="<?php echo esc_attr($location['lat']); ?>" data-lng="<?php echo esc_attr($location['lng']); ?>">
              <h4><?php echo esc_html('Truckn\' America', 'trucknamerica'); ?><br /><small><?php the_title(); ?></small></h4>
              <p class="map-address">
